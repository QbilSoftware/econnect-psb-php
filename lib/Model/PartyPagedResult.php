 ...
 */
class PartyPagedResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PartyPagedResult';
    ...
    */
     ...
     *
     * @param mixed|null $continuation_token continuation_token
     *
     * @return self
     */
    public function setContinuationToken($continuation_token)
    {
        if (is_null($continuation_token)) {
            ...
            $index = array_search('continuation_token', $nullablesSetToNull, true);
            if ($index !== false) {
    ...
    public function setItems($items)
    {
        if (is_null($items)) {
            ...
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('items', $nullablesSetToNull, true);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
