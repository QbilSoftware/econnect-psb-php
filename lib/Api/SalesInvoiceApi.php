...
class SalesInvoiceApi
{
    ...
    {
        list($response) = $this->getSalesInvoiceStatusesWithHttpInfo($party_id, $document_id, $contentType);
        return $response;
    }
     ...
     */
    public function getSalesInvoiceStatusesAsync($party_id, $document_id, string $contentType = self::contentTypes['getSalesInvoiceStatuses'][0])
    {
        return $this->getSalesInvoiceStatusesAsyncWithHttpInfo($party_id, $document_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function getSalesInvoiceStatusesRequest($party_id, $document_id, string $contentType = self::contentTypes['getSalesInvoiceStatuses'][0])
    {
    ...
    {
        list($response) = $this->queryRecipientPartyForSalesInvoiceWithHttpInfo($party_id, $request_body, $preferred_document_type_id, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function queryRecipientPartyForSalesInvoiceAsync($party_id, $request_body, $preferred_document_type_id = null, string $contentType = self::contentTypes['queryRecipientPartyForSalesInvoice'][0])
    {
        return $this->queryRecipientPartyForSalesInvoiceAsyncWithHttpInfo($party_id, $request_body, $preferred_document_type_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function queryRecipientPartyForSalesInvoiceRequest($party_id, $request_body, $preferred_document_type_id = null, string $contentType = self::contentTypes['queryRecipientPartyForSalesInvoice'][0])
    {
    ...
    {
        list($response) = $this->recognizeSalesInvoiceWithHttpInfo($party_id, $file, $channel, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function recognizeSalesInvoiceAsync($party_id, $file, $channel = null, string $contentType = self::contentTypes['recognizeSalesInvoice'][0])
    {
        return $this->recognizeSalesInvoiceAsyncWithHttpInfo($party_id, $file, $channel, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function recognizeSalesInvoiceRequest($party_id, $file, $channel = null, string $contentType = self::contentTypes['recognizeSalesInvoice'][0])
    {
    ...
    {
        list($response) = $this->sendSalesInvoiceWithHttpInfo($party_id, $file, $receiver_id, $channel, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendSalesInvoiceAsync($party_id, $file, $receiver_id = null, $channel = null, string $contentType = self::contentTypes['sendSalesInvoice'][0])
    {
        return $this->sendSalesInvoiceAsyncWithHttpInfo($party_id, $file, $receiver_id, $channel, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function sendSalesInvoiceRequest($party_id, $file, $receiver_id = null, $channel = null, string $contentType = self::contentTypes['sendSalesInvoice'][0])
    {
